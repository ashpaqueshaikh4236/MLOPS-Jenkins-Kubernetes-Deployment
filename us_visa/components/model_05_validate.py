from us_visa.entity.config_entity import ModelValidateConfig
...
class ModelValidate:
    ...
    def __init__(self, model_val_config: ModelValidateConfig, data_ingestion_artifact: DataIngestionArtifact,model_trainer_artifact: ModelTrainerArtifact):
        try:
